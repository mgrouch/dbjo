...
final class RocksJdbcResultSet implements ResultSet {
    private final WebRowSet delegate;

    RocksJdbcResultSet(WebRowSet delegate) {
        this.delegate = Objects.requireNonNull(delegate, "delegate");
    }

    static ResultSet wrap(WebRowSet delegate) {
        return new RocksJdbcResultSet(delegate);
    }
