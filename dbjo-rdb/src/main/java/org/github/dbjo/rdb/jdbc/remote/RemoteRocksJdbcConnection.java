...
public final class RemoteRocksJdbcConnection implements Connection {
    ...
    RemoteRocksJdbcConnection(String url, Properties info, RemoteRocksJdbcClient client, RocksJdbcCatalog catalog) {
        ...
        this.schemaNames = catalog.schemaNames();
        this.defaultSchema = schemaNames.isEmpty() ? "PUBLIC" : schemaNames.getFirst();
    ...
    public Statement createStatement(int resultSetType, int resultSetConcurrency) throws SQLException {
        ...
        return new RemoteRocksJdbcStatement(this, resultSetType, holdability);
    }
    ...
    public Statement createStatement(int resultSetType, int resultSetConcurrency, int resultSetHoldability) throws SQLException {
        ...
        return new RemoteRocksJdbcStatement(this, resultSetType, resultSetHoldability);
    }
    ...
    private String resolveSchema(String schema) throws SQLException {
        String candidate = (schema == null || schema.isBlank()) ? defaultSchema : schema;
        for (String known : schemaNames) {
